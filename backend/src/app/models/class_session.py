...
class ClassSession(Base):
    ...
    session_date: Mapped[datetime.datetime] = mapped_column(DateTime)

    class_: Mapped['Class'] = relationship('Class', back_populates='class_session')
    room: Mapped['Room'] = relationship('Room', back_populates='class_session')
    teacher: Mapped['Employee'] = relationship('Employee', back_populates='class_session')
