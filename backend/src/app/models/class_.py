...
from sqlalchemy import Computed, Date, ForeignKeyConstraint, Index, Integer, String, text
...
class Class(Base):
    ...
    prerequisites: Mapped[str] = mapped_column(String(20))
    ...
    end_date: Mapped[Optional[datetime.date]] = mapped_column(Date, Computed('start_date + INTERVAL duration MONTH', persisted=True))

    teacher: Mapped['Employee'] = relationship('Employee', back_populates='class_')
