...
class StudentAttendance(Base):
    ...
    __table_args__ = (
        ...
        ForeignKeyConstraint(['class_session_id', 'class_id', 'class_date', 'term'], ['class_session.id', 'class_session.class_id', 'class_session.class_date', 'class_session.term'], name='FK_student_attendance_class_session'),
    ...
    class_session: Mapped['ClassSession'] = relationship('ClassSession', back_populates='student_attendance')
    enrolment: Mapped['Enrolment'] = relationship('Enrolment', back_populates='student_attendance')
    student: Mapped['Student'] = relationship('Student', back_populates='student_attendance')
