...
class StaffCheckin(Base):
    ...
    status: Mapped[str] = mapped_column(String(200), nullable=False, server_default=text("'Not Checked In'"))
    ...
    employee: Mapped['Employee'] = relationship('Employee', back_populates='staff_checkin', uselist=False)