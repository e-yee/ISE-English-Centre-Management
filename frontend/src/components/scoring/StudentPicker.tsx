...
export const StudentPicker: React.FC<StudentPickerProps> = ({
  ...
  return (
    <Card className={cn('h-full w-full max-w-full overflow-hidden bg-white border border-gray-200 shadow-sm rounded-[15px]', className)}>
      <CardContent className="p-4 pt-3 w-full h-full flex flex-col">
        <div className="mb-1">
          <p className="font-bold text-left text-xl text-violet-600">
            {"Class " +_classId}
          </p>
        </div>
        <div className="w-full items-center gap-3 mb-3">
