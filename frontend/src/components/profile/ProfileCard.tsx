  ...
  return (
    <Card className={cn("h-full flex-1 selection:bg-purple-400 selection:text-white bg-white rounded-[15px] shadow-lg", className)}>
      ...
      <div className="flex flex-col justify-center items-center w-full rounded-t-[15px] bg-gradient-to-r from-[#c9def4] via-[#f5ccd4] to-[#b8a4c9]">                
        ...
        <p className="font-semibold text-sm animate-bounce duration-900 ease-in-out">Hope you have a wonderful day.</p>
      </div>
      ...
      <CardContent className="px-9 pb-4 pt-4">
        ...
        <div className="flex items-center gap-x-4 mb-2">
          ...
          <Button
            ...
            className={cn(
              "cursor-pointer px-9 py-5 rounded-[15px] font-bold text-white text-[24px]",
              isEditing 
                ? "bg-green-500 hover:bg-green-600 hover:scale-92" 
                : "bg-[#AACEEC] hover:scale-105 hover:bg-blue-400 hover:shadow-xl hover:border hover:border-blue-500 hover:border-2"
            )}
          >
            {isEditing ? "Save" : "Edit"}
          </Button>
