          ...
          <div className="px-6 pt-4 pb-2 flex-shrink-0 flex items-center justify-between">
            <div className="flex items-center gap-4">
              <button
                ...
                className="cursor-pointer bg-white border border-black/20 rounded-[10px] shadow-sm px-4 py-2 transition-all duration-200 ease-in-out hover:shadow-md hover:scale-105 focus:outline-none focus:ring-1 focus:ring-black focus:ring-offset-1 min-w-[90px]"
              >
              ...
              <h1 className="text-3xl font-bold text-purple-600">Staff</h1>
            </div>
