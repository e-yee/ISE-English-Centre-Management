  ...
  return (
    <div className="p-6 h-[calc(100vh-6rem)] overflow-y-auto">
      <div className="flex items-center gap-4 mb-6">
        <button
          onClick={() => navigate(-1)}
          className="cursor-pointer bg-red-400 px-4 py-1 hover:scale-96 rounded-lg"
        >
          <span className="text-[16px] font-semibold text-white font-comfortaa whitespace-nowrap">Back</span>
        </button>
        <h1 className="text-4xl text-violet-600 font-bold">Statistics</h1>
      </div>
